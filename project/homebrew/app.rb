class solitaire < Formula
  ...
  if OS.mac?
      url "https://github.com/kyleu/solitaire/releases/download/#{version}/solitaire-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "e06290a647306d92f1a20c9903060814f6938099a08437b929b32c256aa1dc2c"
  elsif OS.linux?
      url "https://github.com/kyleu/solitaire/releases/download/#{version}/solitaire-#{version}-x86_64-unknown-linux-gnu.tar.gz"

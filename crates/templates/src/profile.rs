...
use solitaire_core::profile::Theme;
...
fn nav_swatch(p: &solitaire_core::profile::UserProfile, c: &str) -> Markup {
...
fn link_swatch(p: &solitaire_core::profile::UserProfile, c: &str) -> Markup {
